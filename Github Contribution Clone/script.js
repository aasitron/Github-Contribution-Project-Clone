...
function stickColor(squaresTile){
    const gettinColor = greenColor2();
    squaresTile.style.backgroundColor = gettinColor;
    squaresTile.style.boxshadow = `0 0 2px ${gettinColor}, 0 0 10px ${gettinColor}`;
}

function addColor(squaresTile){
    const gettinColor = greenColor();
    squaresTile.style.backgroundColor = gettinColor;
    squaresTile.style.boxshadow = `0 0 2px ${gettinColor}, 0 0 10px ${gettinColor}`;
}
